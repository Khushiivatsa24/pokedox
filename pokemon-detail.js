...
async function navigatePokemon(id) {
 ...
 function rgbaFromHex(hexxColor) {
    return [
        parseInt(hexxColor.slice(1,3),16),
        parseInt(hexxColor.slice(3,5),16),
        parseInt(hexxColor.slice(5,7),16),
    ].join(", ");
 }
 ...
 function setTypeBackgroundColor(pokemon){
    ...
    setElementsStyles(document.querySelectorAll(".power-wrapper > p"),"backgroundColor", color);
